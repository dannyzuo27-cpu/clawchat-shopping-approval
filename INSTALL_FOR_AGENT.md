...
目标：把本仓库安装为 ClawChat 专属家庭记账与购物审批 Liveware。不要修改你现有的模型、名字、人设、记忆或其他 Skill。
...
9. 分别从聊天框和 Liveware 各记一笔账，确认它们出现在同一个人账本中。
10. 分别从聊天框和 Liveware 各提交一次购物申请，确认两条记录都能在同一列表出现；再让 Agent 回写初审、人类回写终审。
